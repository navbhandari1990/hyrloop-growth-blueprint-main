  ...
  return <section id="contact" className="py-20 bg-white section-padding">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-hyrloop-blue/10 text-hyrloop-blue hover:bg-hyrloop-blue/20 px-4 py-2 text-sm">Get In Touch</Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Let's Build Something Great Together</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Tell us where you are in your startup journey. We'll help you scale.
          </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contact@hyrloop.com</p>
                </div>
              </div>
